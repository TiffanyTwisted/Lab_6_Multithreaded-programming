package bsu.rfict.java.group7.lab6.Shirko;
...
public class Main  extends JFrame  {
    ...
    public Main (){
        super("Программирование и синхонизация потоков");
        setSize(WIDTH, HEIGHT);
        // Центровка
        Toolkit kit = Toolkit.getDeffaultToolkit();
        setLocation((kit.getScreenSize().width - WIDTN)/2,
